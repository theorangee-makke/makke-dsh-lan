...
## 已知设备 IP（2026-08-29 路由器表，供 lsof 对号）

- mini 本体 .12 · Mac .118/.137 · MacBookAir .61 · iPad .117/.222 · iPhone .160/.190
- Apple TV .71 · ROG2025 .73 · 门口机 .165/.96
- ⚠ Apple 设备 MAC 全部随机化，靠路由器主机名识别，IP 可能因 DHCP 漂移（mini 已固定除外）
